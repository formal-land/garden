...
Definition configure_1 : 𝓒 columns unit :=
  configure_instance
    ...
    Garden.Halo2.halo2_gadgets.utilities.cond_swap.configure_1
    Advice.A0
    Advice.A1
    Advice.A2
    Advice.A3
...
Definition configure_2 : 𝓒 columns unit :=
  configure_instance
    ...
    Garden.Halo2.halo2_gadgets.utilities.cond_swap.configure_2
    Advice.A5
    Advice.A6
    Advice.A7
    Advice.A8
...
Definition synthesize_1
  ...
  synthesize_instance
    Selector.QMerkleDecompose1
    Garden.Halo2.halo2_gadgets.utilities.cond_swap.synthesize_1.

Definition synthesize_2
    : 𝓛 columns RegionId.t unit :=
  synthesize_instance
    Selector.QMerkleDecompose2
    Garden.Halo2.halo2_gadgets.utilities.cond_swap.synthesize_2.
