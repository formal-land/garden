...
Definition x_r
  ...
  Garden.Halo2.halo2_gadgets.utilities.square lambda_1 ➖ x_a ➖ x_p.
...
Definition sinsemilla_gate
  ...
  Gate.constraints :=
    ...
    let secant_line :=
      Garden.Halo2.halo2_gadgets.utilities.square lambda_2_cur
...
Definition sinsemilla_s_x (index : Z) : Z :=
  Garden.Halo2.halo2_gadgets.sinsemilla.sinsemilla_s.x index.

Definition sinsemilla_s_y (index : Z) : Z :=
  Garden.Halo2.halo2_gadgets.sinsemilla.sinsemilla_s.y index.
