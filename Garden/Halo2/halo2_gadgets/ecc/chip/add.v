...
Definition complete_addition_gate : Gate.t columns := {|
  ...
  Gate.constraints :=
    ...
    let poly2 :=
      let three_x_p_sq :=
        three ✖️ Garden.Halo2.halo2_gadgets.utilities.square x_p in
    ...
    let nonexceptional_x_r :=
      Garden.Halo2.halo2_gadgets.utilities.square lambda ➖ x_p ➖ x_q ➖ x_r in
...
Definition configure : 𝓒 columns unit :=
  do🞵 𝓒.CreateGate complete_addition_gate in
  return🞵 tt.
...
Definition synthesize
  ...
  𝓛.AddRegion
    ...
    𝓡.EnableSelector Selector.QEccAdd 0 "").
