...
Definition full_round_row
  ...
  (Selector.QPoseidonFull, [
    (Fixed.LagrangeCoeffs2, annotation_0,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round 0);
    (Fixed.LagrangeCoeffs3, annotation_1,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round 1);
    (Fixed.LagrangeCoeffs4, annotation_2,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round 2)
  ]).
...
Definition partial_round_row
  ...
  (Selector.QPoseidonPartial, [
    (Fixed.LagrangeCoeffs2, annotation_a_0,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_a 0);
    (Fixed.LagrangeCoeffs3, annotation_a_1,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_a 1);
    (Fixed.LagrangeCoeffs4, annotation_a_2,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_a 2);
    (Fixed.LagrangeCoeffs5, annotation_b_0,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_b 0);
    (Fixed.LagrangeCoeffs6, annotation_b_1,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_b 1);
    (Fixed.LagrangeCoeffs7, annotation_b_2,
      Garden.Halo2.Gadgets.Poseidon.P128Pow5T3.round_constant round_b 2)
  ]).
