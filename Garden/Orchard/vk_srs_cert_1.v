(** * Vesta SRS provenance, shard 1: generators [g_128 .. g_255]
...
(** The entry indices are exactly [128 .. 255], in order. *)
Lemma vk_srs_shard_1_indices :
  List.map VkSrsEntry.index VkSrsData1.shard
  = List.map (fun n : nat => 128 + Z.of_nat n) (List.seq 0 128).
