(** * Vesta SRS provenance, shard 11: generators [g_1408 .. g_1535]
...
(** The entry indices are exactly [1408 .. 1535], in order. *)
Lemma vk_srs_shard_11_indices :
  List.map VkSrsEntry.index VkSrsData11.shard
  = List.map (fun n : nat => 1408 + Z.of_nat n) (List.seq 0 128).
