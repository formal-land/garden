(** * Vesta SRS provenance, shard 2: generators [g_256 .. g_383]
...
(** The entry indices are exactly [256 .. 383], in order. *)
Lemma vk_srs_shard_2_indices :
  List.map VkSrsEntry.index VkSrsData2.shard
  = List.map (fun n : nat => 256 + Z.of_nat n) (List.seq 0 128).
