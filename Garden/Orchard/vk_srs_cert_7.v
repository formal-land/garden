(** * Vesta SRS provenance, shard 7: generators [g_896 .. g_1023]
...
(** The entry indices are exactly [896 .. 1023], in order. *)
Lemma vk_srs_shard_7_indices :
  List.map VkSrsEntry.index VkSrsData7.shard
  = List.map (fun n : nat => 896 + Z.of_nat n) (List.seq 0 128).
