(** * Vesta SRS provenance, shard 10: generators [g_1280 .. g_1407]
...
(** The entry indices are exactly [1280 .. 1407], in order. *)
Lemma vk_srs_shard_10_indices :
  List.map VkSrsEntry.index VkSrsData10.shard
  = List.map (fun n : nat => 1280 + Z.of_nat n) (List.seq 0 128).
