(** * Vesta SRS provenance, shard 8: generators [g_1024 .. g_1151]
...
(** The entry indices are exactly [1024 .. 1151], in order. *)
Lemma vk_srs_shard_8_indices :
  List.map VkSrsEntry.index VkSrsData8.shard
  = List.map (fun n : nat => 1024 + Z.of_nat n) (List.seq 0 128).
