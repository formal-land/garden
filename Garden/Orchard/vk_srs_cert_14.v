(** * Vesta SRS provenance, shard 14: generators [g_1792 .. g_1919]
...
(** The entry indices are exactly [1792 .. 1919], in order. *)
Lemma vk_srs_shard_14_indices :
  List.map VkSrsEntry.index VkSrsData14.shard
  = List.map (fun n : nat => 1792 + Z.of_nat n) (List.seq 0 128).
