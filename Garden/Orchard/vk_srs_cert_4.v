(** * Vesta SRS provenance, shard 4: generators [g_512 .. g_639]
...
(** The entry indices are exactly [512 .. 639], in order. *)
Lemma vk_srs_shard_4_indices :
  List.map VkSrsEntry.index VkSrsData4.shard
  = List.map (fun n : nat => 512 + Z.of_nat n) (List.seq 0 128).
