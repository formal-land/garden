(** * Vesta SRS provenance, shard 6: generators [g_768 .. g_895]
...
(** The entry indices are exactly [768 .. 895], in order. *)
Lemma vk_srs_shard_6_indices :
  List.map VkSrsEntry.index VkSrsData6.shard
  = List.map (fun n : nat => 768 + Z.of_nat n) (List.seq 0 128).
