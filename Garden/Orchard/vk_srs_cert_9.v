(** * Vesta SRS provenance, shard 9: generators [g_1152 .. g_1279]
...
(** The entry indices are exactly [1152 .. 1279], in order. *)
Lemma vk_srs_shard_9_indices :
  List.map VkSrsEntry.index VkSrsData9.shard
  = List.map (fun n : nat => 1152 + Z.of_nat n) (List.seq 0 128).
