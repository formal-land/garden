(** * Vesta SRS provenance, shard 3: generators [g_384 .. g_511]
...
(** The entry indices are exactly [384 .. 511], in order. *)
Lemma vk_srs_shard_3_indices :
  List.map VkSrsEntry.index VkSrsData3.shard
  = List.map (fun n : nat => 384 + Z.of_nat n) (List.seq 0 128).
