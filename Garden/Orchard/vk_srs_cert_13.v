(** * Vesta SRS provenance, shard 13: generators [g_1664 .. g_1791]
...
(** The entry indices are exactly [1664 .. 1791], in order. *)
Lemma vk_srs_shard_13_indices :
  List.map VkSrsEntry.index VkSrsData13.shard
  = List.map (fun n : nat => 1664 + Z.of_nat n) (List.seq 0 128).
