(** * Vesta SRS provenance, shard 0: generators [g_0 .. g_127]
...
(** The entry indices are exactly [0 .. 127], in order. *)
Lemma vk_srs_shard_0_indices :
  List.map VkSrsEntry.index VkSrsData0.shard
  = List.map (fun n : nat => 0 + Z.of_nat n) (List.seq 0 128).
