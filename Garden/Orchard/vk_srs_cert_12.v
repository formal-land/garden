(** * Vesta SRS provenance, shard 12: generators [g_1536 .. g_1663]
...
(** The entry indices are exactly [1536 .. 1663], in order. *)
Lemma vk_srs_shard_12_indices :
  List.map VkSrsEntry.index VkSrsData12.shard
  = List.map (fun n : nat => 1536 + Z.of_nat n) (List.seq 0 128).
