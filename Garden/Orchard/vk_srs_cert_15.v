(** * Vesta SRS provenance, shard 15: generators [g_1920 .. g_2047]
...
(** The entry indices are exactly [1920 .. 2047], in order. *)
Lemma vk_srs_shard_15_indices :
  List.map VkSrsEntry.index VkSrsData15.shard
  = List.map (fun n : nat => 1920 + Z.of_nat n) (List.seq 0 128).
