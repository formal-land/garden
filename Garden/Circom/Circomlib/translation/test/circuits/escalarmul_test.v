...
Definition Main : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "escalarMul" [Access.Component "inp"; Access.Array (0)] [[ 0 ]] in
    do~ M.substitute_var "escalarMul" [Access.Component "inp"; Access.Array (1)] [[ 1 ]] in
    (* Var *)
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 253 |) ]] (
      do~ M.substitute_var "escalarMul" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2b", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.substitute_var "out" [Access.Array (0)] [[ M.var_access (| "escalarMul", [Access.Component "out"; Access.Array (0)] |) ]] in
    do~ M.substitute_var "out" [Access.Array (1)] [[ M.var_access (| "escalarMul", [Access.Component "out"; Access.Array (1)] |) ]] in
    M.pure BlockUnit.Tt
  ).
