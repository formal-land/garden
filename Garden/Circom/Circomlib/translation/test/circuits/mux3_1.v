...
Definition Constants : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "out" [Access.Array (4)] [[ 89 ]] in
    do~ M.substitute_var "out" [Access.Array (5)] [[ 107 ]] in
    do~ M.substitute_var "out" [Access.Array (6)] [[ 163 ]] in
    do~ M.substitute_var "out" [Access.Array (7)] [[ 191 ]] in
    M.pure BlockUnit.Tt
  ).
...
Definition Main : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "mux" [] [[ M.call_function ~(| "Mux3", ([] : list F.t) |) ]] in
    (* Component *)
    do~ M.declare_component "n2b" in
    do~ M.substitute_var "n2b" [] [[ M.call_function ~(| "Num2Bits", [ 3 ] |) ]] in
    (* Component *)
