...
Definition Main : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "p2b" [Access.Component "in"; Access.Array (0)] [[ M.var_access (| "in", [Access.Array (0)] |) ]] in
    do~ M.substitute_var "p2b" [Access.Component "in"; Access.Array (1)] [[ M.var_access (| "in", [Access.Array (1)] |) ]] in
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 256 |) ]] (
      do~ M.substitute_var "b2p" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "p2b", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
