...
Definition Main : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 253 |) ]] (
      do~ M.substitute_var "escalarMul" [Access.Component "e"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2b", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
...
Definition Main_not_under_constrained e : Prop :=
  exists! out,
  let signals := MainSignals.Build_t e out in
