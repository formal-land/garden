...
Definition Window4 : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "out" [Access.Array (1)] [[ InfixOp.add ~(| InfixOp.mul ~(| InfixOp.mul ~(| PrefixOp.sub ~(| M.var_access (| "mux", [Access.Component "out"; Access.Array (1)] |) |), 2 |), M.var_access (| "in", [Access.Array (3)] |) |), M.var_access (| "mux", [Access.Component "out"; Access.Array (1)] |) |) ]] in
    M.pure BlockUnit.Tt
  ).

(* Template not under-constrained *)
Definition Window4_not_under_constrained in_ base : Prop :=
  exists! out out8,
  let signals := Window4Signals.Build_t in_ base out out8 in
  True (* NotUnderConstrained Window4 signals *).
...
Definition Segment (nWindows : F.t) : M.t (BlockUnit.t Empty_set) :=
  M.template_body [("nWindows", nWindows)] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), M.var (| "nWindows" |) |) ]] (
      do~ M.substitute_var "windows" [Access.Array (M.var (| "i" |))] [[ M.call_function ~(| "Window4", ([] : list F.t) |) ]] in
      do~ M.substitute_var "j" [] [[ 0 ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), 4 |) ]] (
        do~ M.substitute_var "windows" [Access.Array (M.var (| "i" |)); Access.Component "in"; Access.Array (M.var (| "j" |))] [[ M.var_access (| "in", [Access.Array (InfixOp.add ~(| InfixOp.mul ~(| 4, M.var (| "i" |) |), M.var (| "j" |) |))] |) ]] in
      ...
      do~ M.if_ [[ InfixOp.eq ~(| M.var (| "i" |), 0 |) ]] (* then *) (
        ...
        do~ M.substitute_var "doublers1" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |))] [[ M.call_function ~(| "MontgomeryDouble", ([] : list F.t) |) ]] in
        do~ M.substitute_var "doublers2" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |))] [[ M.call_function ~(| "MontgomeryDouble", ([] : list F.t) |) ]] in
        do~ M.substitute_var "doublers1" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in"; Access.Array (0)] [[ M.var_access (| "windows", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out8"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "doublers1" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in"; Access.Array (1)] [[ M.var_access (| "windows", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out8"; Access.Array (1)] |) ]] in
        do~ M.substitute_var "doublers2" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in"; Access.Array (0)] [[ M.var_access (| "doublers1", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "doublers2" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in"; Access.Array (1)] [[ M.var_access (| "doublers1", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (1)] |) ]] in
        do~ M.substitute_var "windows" [Access.Array (M.var (| "i" |)); Access.Component "base"; Access.Array (0)] [[ M.var_access (| "doublers2", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "windows" [Access.Array (M.var (| "i" |)); Access.Component "base"; Access.Array (1)] [[ M.var_access (| "doublers2", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (1)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |))] [[ M.call_function ~(| "MontgomeryAdd", ([] : list F.t) |) ]] in
        do~ M.if_ [[ InfixOp.eq ~(| M.var (| "i" |), 1 |) ]] (* then *) (
          do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in1"; Access.Array (0)] [[ M.var_access (| "windows", [Access.Array (0); Access.Component "out"; Access.Array (0)] |) ]] in
          do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in1"; Access.Array (1)] [[ M.var_access (| "windows", [Access.Array (0); Access.Component "out"; Access.Array (1)] |) ]] in
          M.pure BlockUnit.Tt
        ) (* else *) (
          do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in1"; Access.Array (0)] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 2 |)); Access.Component "out"; Access.Array (0)] |) ]] in
          do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in1"; Access.Array (1)] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 2 |)); Access.Component "out"; Access.Array (1)] |) ]] in
          M.pure BlockUnit.Tt
        ) in
        do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in2"; Access.Array (0)] [[ M.var_access (| "windows", [Access.Array (M.var (| "i" |)); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "in2"; Access.Array (1)] [[ M.var_access (| "windows", [Access.Array (M.var (| "i" |)); Access.Component "out"; Access.Array (1)] |) ]] in
        M.pure BlockUnit.Tt
      ) in
    ...
    do~ M.if_ [[ InfixOp.greater ~(| M.var (| "nWindows" |), 1 |) ]] (* then *) (
      do~ M.substitute_var "m2e" [Access.Component "in"; Access.Array (0)] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "nWindows" |), 2 |)); Access.Component "out"; Access.Array (0)] |) ]] in
      do~ M.substitute_var "m2e" [Access.Component "in"; Access.Array (1)] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "nWindows" |), 2 |)); Access.Component "out"; Access.Array (1)] |) ]] in
      M.pure BlockUnit.Tt
    ) (* else *) (
      do~ M.substitute_var "m2e" [Access.Component "in"; Access.Array (0)] [[ M.var_access (| "windows", [Access.Array (0); Access.Component "out"; Access.Array (0)] |) ]] in
      do~ M.substitute_var "m2e" [Access.Component "in"; Access.Array (1)] [[ M.var_access (| "windows", [Access.Array (0); Access.Component "out"; Access.Array (1)] |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.substitute_var "out" [Access.Array (0)] [[ M.var_access (| "m2e", [Access.Component "out"; Access.Array (0)] |) ]] in
    do~ M.substitute_var "out" [Access.Array (1)] [[ M.var_access (| "m2e", [Access.Component "out"; Access.Array (1)] |) ]] in
    M.pure BlockUnit.Tt
  ).

(* Template not under-constrained *)
Definition Segment_not_under_constrained (nWindows : F.t) in_ base : Prop :=
  exists! out,
  let signals := SegmentSignals.Build_t in_ base out in
  True (* NotUnderConstrained Segment nWindows signals *).
...
Definition Pedersen (n : F.t) : M.t (BlockUnit.t Empty_set) :=
  M.template_body [("n", n)] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), M.var (| "nSegments" |) |) ]] (
      ...
      do~ M.substitute_var "segments" [Access.Array (M.var (| "i" |))] [[ M.call_function ~(| "Segment", [ M.var (| "nWindows" |) ] |) ]] in
      do~ M.substitute_var "segments" [Access.Array (M.var (| "i" |)); Access.Component "base"; Access.Array (0)] [[ M.var_access (| "BASE", [Access.Array (M.var (| "i" |)); Access.Array (0)] |) ]] in
      do~ M.substitute_var "segments" [Access.Array (M.var (| "i" |)); Access.Component "base"; Access.Array (1)] [[ M.var_access (| "BASE", [Access.Array (M.var (| "i" |)); Access.Array (1)] |) ]] in
      do~ M.substitute_var "j" [] [[ 0 ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), M.var (| "nBits" |) |) ]] (
        do~ M.substitute_var "segments" [Access.Array (M.var (| "i" |)); Access.Component "in"; Access.Array (M.var (| "j" |))] [[ M.var_access (| "in", [Access.Array (InfixOp.add ~(| InfixOp.mul ~(| M.var (| "i" |), 200 |), M.var (| "j" |) |))] |) ]] in
        do~ M.substitute_var "j" [] [[ InfixOp.add ~(| M.var (| "j" |), 1 |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.substitute_var "j" [] [[ M.var (| "nBits" |) ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), InfixOp.mul ~(| M.var (| "nWindows" |), 4 |) |) ]] (
        do~ M.substitute_var "segments" [Access.Array (M.var (| "i" |)); Access.Component "in"; Access.Array (M.var (| "j" |))] [[ 0 ]] in
        do~ M.substitute_var "j" [] [[ InfixOp.add ~(| M.var (| "j" |), 1 |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), InfixOp.sub ~(| M.var (| "nSegments" |), 1 |) |) ]] (
      do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |))] [[ M.call_function ~(| "BabyAdd", ([] : list F.t) |) ]] in
      do~ M.if_ [[ InfixOp.eq ~(| M.var (| "i" |), 0 |) ]] (* then *) (
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "x1"] [[ M.var_access (| "segments", [Access.Array (0); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "y1"] [[ M.var_access (| "segments", [Access.Array (0); Access.Component "out"; Access.Array (1)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "x2"] [[ M.var_access (| "segments", [Access.Array (1); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "y2"] [[ M.var_access (| "segments", [Access.Array (1); Access.Component "out"; Access.Array (1)] |) ]] in
        M.pure BlockUnit.Tt
      ) (* else *) (
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "x1"] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "xout"] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "y1"] [[ M.var_access (| "adders", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "yout"] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "x2"] [[ M.var_access (| "segments", [Access.Array (InfixOp.add ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "adders" [Access.Array (M.var (| "i" |)); Access.Component "y2"] [[ M.var_access (| "segments", [Access.Array (InfixOp.add ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (1)] |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
