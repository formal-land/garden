...
Definition SMTHash1 : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.substitute_var "h" [Access.Component "in"; Access.Array (0)] [[ M.var (| "key" |) ]] in
    do~ M.substitute_var "h" [Access.Component "in"; Access.Array (1)] [[ M.var (| "value" |) ]] in
    do~ M.substitute_var "h" [Access.Component "k"] [[ 1 ]] in
...
Definition SMTHash2 : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.declare_component "h" in
    do~ M.substitute_var "h" [] [[ M.call_function ~(| "MultiMiMC7", [ 2; 91 ] |) ]] in
    do~ M.substitute_var "h" [Access.Component "in"; Access.Array (0)] [[ M.var (| "L" |) ]] in
    do~ M.substitute_var "h" [Access.Component "in"; Access.Array (1)] [[ M.var (| "R" |) ]] in
    do~ M.substitute_var "h" [Access.Component "k"] [[ 0 ]] in
    do~ M.substitute_var "out" [] [[ M.var_access (| "h", [Access.Component "out"] |) ]] in
    M.pure BlockUnit.Tt
  ).
