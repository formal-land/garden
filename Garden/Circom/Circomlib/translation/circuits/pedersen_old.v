...
Definition Pedersen (n : F.t) : M.t (BlockUnit.t Empty_set) :=
  M.template_body [("n", n)] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), M.var (| "nexps" |) |) ]] (
      ...
      do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |))] [[ M.call_function ~(| "EscalarMul", [ M.var (| "nexpbits" |); M.var_access (| "PBASE", [Access.Array (M.var (| "i" |))] |) ] |) ]] in
      do~ M.substitute_var "j" [] [[ 0 ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), M.var (| "nexpbits" |) |) ]] (
        do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |)); Access.Component "in"; Access.Array (M.var (| "j" |))] [[ M.var_access (| "in", [Access.Array (InfixOp.add ~(| InfixOp.mul ~(| 250, M.var (| "i" |) |), M.var (| "j" |) |))] |) ]] in
        do~ M.substitute_var "j" [] [[ InfixOp.add ~(| M.var (| "j" |), 1 |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.if_ [[ InfixOp.eq ~(| M.var (| "i" |), 0 |) ]] (* then *) (
        do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |)); Access.Component "inp"; Access.Array (0)] [[ 0 ]] in
        do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |)); Access.Component "inp"; Access.Array (1)] [[ 1 ]] in
        M.pure BlockUnit.Tt
      ) (* else *) (
        do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |)); Access.Component "inp"; Access.Array (0)] [[ M.var_access (| "escalarMuls", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (0)] |) ]] in
        do~ M.substitute_var "escalarMuls" [Access.Array (M.var (| "i" |)); Access.Component "inp"; Access.Array (1)] [[ M.var_access (| "escalarMuls", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 1 |)); Access.Component "out"; Access.Array (1)] |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.substitute_var "out" [Access.Array (0)] [[ M.var_access (| "escalarMuls", [Access.Array (InfixOp.sub ~(| M.var (| "nexps" |), 1 |)); Access.Component "out"; Access.Array (0)] |) ]] in
    do~ M.substitute_var "out" [Access.Array (1)] [[ M.var_access (| "escalarMuls", [Access.Array (InfixOp.sub ~(| M.var (| "nexps" |), 1 |)); Access.Component "out"; Access.Array (1)] |) ]] in
    M.pure BlockUnit.Tt
  ).
