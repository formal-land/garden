...
Definition sha256compression (hin inp : F.t) : M.t F.t :=
  M.function_body [("hin", hin); ("inp", inp)] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 8 |) ]] (
      do~ M.substitute_var "H" [Access.Array (M.var (| "i" |))] [[ 0 ]] in
      (* Var *)
      do~ M.declare_var "j" [[ ([] : list F.t) ]] in
      do~ M.substitute_var "j" [] [[ 0 ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), 32 |) ]] (
        do~ M.substitute_var "H" [Access.Array (M.var (| "i" |))] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (M.var (| "i" |))] |), InfixOp.shiftL ~(| M.var_access (| "hin", [Access.Array (InfixOp.add ~(| InfixOp.mul ~(| M.var (| "i" |), 32 |), M.var (| "j" |) |))] |), M.var (| "j" |) |) |) ]] in
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 64 |) ]] (
      do~ M.if_ [[ InfixOp.lesser ~(| M.var (| "i" |), 16 |) ]] (* then *) (
        do~ M.substitute_var "w" [Access.Array (M.var (| "i" |))] [[ 0 ]] in
        (* Var *)
        do~ M.declare_var "j" [[ ([] : list F.t) ]] in
        do~ M.substitute_var "j" [] [[ 0 ]] in
        do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), 32 |) ]] (
          do~ M.substitute_var "w" [Access.Array (M.var (| "i" |))] [[ InfixOp.add ~(| M.var_access (| "w", [Access.Array (M.var (| "i" |))] |), InfixOp.shiftL ~(| M.var_access (| "inp", [Access.Array (InfixOp.sub ~(| InfixOp.add ~(| InfixOp.mul ~(| M.var (| "i" |), 32 |), 31 |), M.var (| "j" |) |))] |), M.var (| "j" |) |) |) ]] in
          do~ M.substitute_var "j" [] [[ InfixOp.add ~(| M.var (| "j" |), 1 |) ]] in
          M.pure BlockUnit.Tt
        ) in
        M.pure BlockUnit.Tt
      ) (* else *) (
        do~ M.substitute_var "w" [Access.Array (M.var (| "i" |))] [[ InfixOp.bitAnd ~(| InfixOp.add ~(| InfixOp.add ~(| InfixOp.add ~(| M.call_function ~(| "ssigma1", [ M.var_access (| "w", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 2 |))] |) ] |), M.var_access (| "w", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 7 |))] |) |), M.call_function ~(| "ssigma0", [ M.var_access (| "w", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 15 |))] |) ] |) |), M.var_access (| "w", [Access.Array (InfixOp.sub ~(| M.var (| "i" |), 16 |))] |) |), 4294967295 |) ]] in
        M.pure BlockUnit.Tt
      ) in
    ...
    do~ M.substitute_var "H" [Access.Array (0)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (0)] |), M.var (| "a" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (1)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (1)] |), M.var (| "b" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (2)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (2)] |), M.var (| "c" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (3)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (3)] |), M.var (| "d" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (4)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (4)] |), M.var (| "e" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (5)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (5)] |), M.var (| "f" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (6)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (6)] |), M.var (| "g" |) |) ]] in
    do~ M.substitute_var "H" [Access.Array (7)] [[ InfixOp.add ~(| M.var_access (| "H", [Access.Array (7)] |), M.var (| "h" |) |) ]] in
    (* Var *)
    do~ M.declare_var "i" [[ ([] : list F.t) ]] in
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 8 |) ]] (
      ...
      do~ M.substitute_var "j" [] [[ 0 ]] in
      do~ M.while [[ InfixOp.lesser ~(| M.var (| "j" |), 32 |) ]] (
        do~ M.substitute_var "out" [Access.Array (InfixOp.sub ~(| InfixOp.add ~(| InfixOp.mul ~(| M.var (| "i" |), 32 |), 31 |), M.var (| "j" |) |))] [[ InfixOp.bitAnd ~(| InfixOp.shiftR ~(| M.var_access (| "H", [Access.Array (M.var (| "i" |))] |), M.var (| "j" |) |), 1 |) ]] in
        do~ M.substitute_var "j" [] [[ InfixOp.add ~(| M.var (| "j" |), 1 |) ]] in
        M.pure BlockUnit.Tt
      ) in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
