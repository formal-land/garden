...
Definition Bits2Point_Strict : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "aliasCheckY" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "in", [Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    ...
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "b2nY" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "in", [Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.substitute_var "out" [Access.Array (1)] [[ M.var_access (| "b2nY", [Access.Component "out"] |) ]] in
    (* Var *)
    ...
    do~ M.substitute_var "out" [Access.Array (0)] [[ M.var (| "x" |) ]] in
    (* Component *)
    do~ M.declare_component "babyCheck" in
    do~ M.substitute_var "babyCheck" [] [[ M.call_function ~(| "BabyCheck", ([] : list F.t) |) ]] in
    do~ M.substitute_var "babyCheck" [Access.Component "x"] [[ M.var_access (| "out", [Access.Array (0)] |) ]] in
    do~ M.substitute_var "babyCheck" [Access.Component "y"] [[ M.var_access (| "out", [Access.Array (1)] |) ]] in
    (* Component *)
    do~ M.declare_component "n2bX" in
    do~ M.substitute_var "n2bX" [] [[ M.call_function ~(| "Num2Bits", [ 254 ] |) ]] in
    do~ M.substitute_var "n2bX" [Access.Component "in"] [[ M.var_access (| "out", [Access.Array (0)] |) ]] in
    (* Component *)
    do~ M.declare_component "aliasCheckX" in
    do~ M.substitute_var "aliasCheckX" [] [[ M.call_function ~(| "AliasCheck", ([] : list F.t) |) ]] in
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "aliasCheckX" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2bX", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    (* Component *)
    ...
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "signCalc" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2bX", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.equality_constraint
...
Definition Point2Bits_Strict : M.t (BlockUnit.t Empty_set) :=
  M.template_body [] (
    ...
    do~ M.declare_component "n2bX" in
    do~ M.substitute_var "n2bX" [] [[ M.call_function ~(| "Num2Bits", [ 254 ] |) ]] in
    do~ M.substitute_var "n2bX" [Access.Component "in"] [[ M.var_access (| "in", [Access.Array (0)] |) ]] in
    (* Component *)
    do~ M.declare_component "n2bY" in
    do~ M.substitute_var "n2bY" [] [[ M.call_function ~(| "Num2Bits", [ 254 ] |) ]] in
    do~ M.substitute_var "n2bY" [Access.Component "in"] [[ M.var_access (| "in", [Access.Array (1)] |) ]] in
    (* Component *)
    do~ M.declare_component "aliasCheckX" in
    do~ M.substitute_var "aliasCheckX" [] [[ M.call_function ~(| "AliasCheck", ([] : list F.t) |) ]] in
    (* Component *)
    ...
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "aliasCheckX" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2bX", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "aliasCheckY" [Access.Component "in"; Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2bY", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    (* Component *)
    ...
    do~ M.substitute_var "i" [] [[ 0 ]] in
    do~ M.while [[ InfixOp.lesser ~(| M.var (| "i" |), 254 |) ]] (
      do~ M.substitute_var "out" [Access.Array (M.var (| "i" |))] [[ M.var_access (| "n2bY", [Access.Component "out"; Access.Array (M.var (| "i" |))] |) ]] in
      do~ M.substitute_var "i" [] [[ InfixOp.add ~(| M.var (| "i" |), 1 |) ]] in
      M.pure BlockUnit.Tt
    ) in
    do~ M.substitute_var "out" [Access.Array (254)] [[ 0 ]] in
    do~ M.substitute_var "out" [Access.Array (255)] [[ M.var_access (| "signCalc", [Access.Component "out"] |) ]] in
    M.pure BlockUnit.Tt
  ).
